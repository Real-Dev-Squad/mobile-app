...
export const cancelOoo = async () => {
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      return res;
    } else throw new Error('Api is failing');
  } catch (err) {
